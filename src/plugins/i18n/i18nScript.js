...
const lang_package = require('./language');    // import Language package
const dir = 'locales';                    // build fileName variable
const country = ['zh','en'];     // Language Items
    ...
    let str = '' 
     if (Array.isArray(obj)) {
        str += `'${obj[index]}',`
         ...
         Object.keys(obj).forEach((next_obj, i) => {
